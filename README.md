...
**AirBnB Clone** is a *full web application*, with integrated database storage, a back-end API, and front-end interface.
...
![final rsult](images/Final_result.png)
...
**Example:**
```bash
boj@DESKTOP-DL5CKN6:~$ ./console.py
(hbnb) help
